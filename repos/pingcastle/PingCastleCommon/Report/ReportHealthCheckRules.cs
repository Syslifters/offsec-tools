...
namespace PingCastle.Report
{
    public class ReportHealthCheckRules : ReportBase
    {
        ...
        public ReportHealthCheckRules()
        {
            // TODO: When we get DI working here, inject IResourceManagerProvider
            IResourceManagerProvider resourceManagerProvider = new ResourceManagerProvider();
            _resourceManager = resourceManagerProvider.GetHealthCheckRuleResourceManager();
        }
