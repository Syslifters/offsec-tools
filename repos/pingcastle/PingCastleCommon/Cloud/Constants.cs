...
namespace PingCastle.Cloud
{
    public class Constants
    {
        ...
        public const string OAuth2AuthorizeEndPoint = "https://login.microsoftonline.com/common/oauth2/v2.0/authorize";
        public const string OAuth2TokenEndPoint = "https://login.microsoftonline.com/common/oauth2/v2.0/token";
        ...
        public const string OpenIdConfigurationEndpoint = "https://login.windows.net/xxxxx/v2.0/.well-known/openid-configuration";
