...
{
    [AzureService("d3590ed6-52b3-4102-aeff-aad2292ab01c", "https://management.azure.com/")]
    public class ManagementApi : RESTClientBase<ManagementApi>, IAzureService
    {
        ...
        public class Headers
        {
            ...
            [JsonPropertyName("x-ms-ratelimit-remaining-tenant-reads")]
            public string XMsRatelimitRemainingTenantReads { get; set; }

            [JsonPropertyName("x-ms-request-id")]
            public string XMsRequestId { get; set; }

            [JsonPropertyName("x-ms-correlation-request-id")]
            public string XMsCorrelationRequestId { get; set; }

            [JsonPropertyName("x-ms-routing-request-id")]
