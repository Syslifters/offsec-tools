...
{
    public abstract class RuleBase<T> : IRuleScore, IMakeAnalysisVisible<T>
    {
        ...
        protected ResourceManager ResourceManager
        {
            ...
            { 
                ...
                _resourceManager = InitResourceManager(); 
                return _resourceManager;
            }
        }
        ...
        private ResourceManager InitResourceManager()
        {
            ...
            {
                // NOTE: We moved resources from PingCastle.* to PingCastleCommon.* namespaces,
                //       but we did not change namespaces on classes. Therefore, we have to replace here.
                var resourceNamespace = @namespace.Replace("PingCastle.", "PingCastleCommon.");
                resourceManager = new ResourceManager($"{resourceNamespace}.RuleDescription", currentType.Assembly);
        ...
        int? IMakeAnalysisVisible<T>.RunAnalysis(T data) => this.AnalyzeDataNew(data);
    }
}
