...
namespace PingCastleCommon.Scanners
{
    ...
    public class Smb2Protocol : ISmb2Protocol
    {
        ...
        private ISSPIHelperFactory _sspiFactory;
        ...
        public Smb2Protocol(Stream stream, string server, ISSPIHelperFactory sspiFactory = null)
        {
            _stream = stream;
            _server = server;
            _sspiFactory = sspiFactory ?? new NullSSPIHelperFactory();
        }
        ...
        {
            ISSPIHelper MyHelper = _sspiFactory.Create(_server);
