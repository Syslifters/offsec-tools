...
- **bloodyad:** Active Directory privilege escalation tool (https://github.com/CravateRouge/bloodyAD)
- **certipy:** Active Directory Certificate Services enumeration and abuse tool (https://github.com/ly4k/Certipy)
- **coercer:** Windows authentication coercion tool (https://github.com/p0dalirius/Coercer)
- **crassus:** Windows privilege escalation discovery tool (https://github.com/vu-ls/Crassus)
- **dnstool:** Active Directory DNS record manipulation tool (https://github.com/dirkjanm/krbrelayx)
- **godpotato:** `SeImpersonate` privilege escalation potato abusing DCOM (https://github.com/BeichenDream/GodPotato)
- **impacket-tools:** Collection of Impacket network protocol tools (https://github.com/fortra/impacket)
...
- **krbrelayx:** Kerberos relaying and unconstrained delegation abuse toolkit (https://github.com/dirkjanm/krbrelayx)
...
- **nxc:** Network execution and lateral movement tool (https://github.com/Pennyw0rth/NetExec)
...
- **pyrdp:** Remote Desktop Protocol Monster-in-the-Middle tool (https://github.com/GoSecure/pyrdp)
...
- **shareranger:** Fileshare discovery and enumeration tool
...
- **sharprelay:** SMB packet relay and port redirection tool (https://github.com/pkb1s/SharpRelay)
- **sharpsccm:** Microsoft Endpoint Configuration Manager post-exploitation tool (https://github.com/Mayyhem/SharpSCCM)
